...
case TRANSACTION_turnPageSide:
{
data.enforceInterface(descriptor);
this.turnPageSide();
return true;
}
case TRANSACTION_setBackLampBacklight:
{
data.enforceInterface(descriptor);
int _arg0;
_arg0 = data.readInt();
this.setBackLampBacklight(_arg0);
return true;
}
case TRANSACTION_turnPageMid:
{
data.enforceInterface(descriptor);
int _arg0;
_arg0 = data.readInt();
this.turnPageMid(_arg0);
return true;
}
...
@Override public void turnPageSide() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_turnPageSide, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void setBackLampBacklight(int level) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(level);
mRemote.transact(Stub.TRANSACTION_setBackLampBacklight, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void turnPageMid(int theme) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(theme);
mRemote.transact(Stub.TRANSACTION_turnPageMid, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_turnPageSide = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_setBackLampBacklight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_turnPageMid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
...
public void turnPageSide() throws android.os.RemoteException;
public void setBackLampBacklight(int level) throws android.os.RemoteException;
public void turnPageMid(int theme) throws android.os.RemoteException;

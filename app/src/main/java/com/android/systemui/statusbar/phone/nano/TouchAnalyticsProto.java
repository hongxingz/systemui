  ...
  public static final class Session extends
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              switch (value) {
                ...
                case TouchEvent.OUTSIDE:
                case TouchEvent.POINTER_DOWN:
                case TouchEvent.POINTER_UP:
                  action_ = value;
                  bitField0_ |= 0x00000002;
                  break;
              }
    ...
    public static final class SensorEvent extends
      ...
      public SensorEvent clearType() {
        type_ = SensorEvent.ACCELEROMETER;
        bitField0_ = (bitField0_ & ~0x00000001);
        return this;
      }
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              int value = input.readInt32();
              switch (value) {
                case SensorEvent.ACCELEROMETER:
                case SensorEvent.GYROSCOPE:
                case SensorEvent.LIGHT:
                case SensorEvent.PROXIMITY:
                case SensorEvent.ROTATION_VECTOR:
                  type_ = value;
                  bitField0_ |= 0x00000001;
                  break;
              }
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              int value = input.readInt32();
              switch (value) {
                case PhoneEvent.ON_SCREEN_ON:
                case PhoneEvent.ON_SCREEN_ON_FROM_TOUCH:
                case PhoneEvent.ON_SCREEN_OFF:
                case PhoneEvent.ON_SUCCESSFUL_UNLOCK:
                case PhoneEvent.ON_BOUNCER_SHOWN:
                case PhoneEvent.ON_BOUNCER_HIDDEN:
                case PhoneEvent.ON_QS_DOWN:
                case PhoneEvent.SET_QS_EXPANDED_TRUE:
                case PhoneEvent.SET_QS_EXPANDED_FALSE:
                case PhoneEvent.ON_TRACKING_STARTED:
                case PhoneEvent.ON_TRACKING_STOPPED:
                case PhoneEvent.ON_NOTIFICATION_ACTIVE:
                case PhoneEvent.ON_NOTIFICATION_INACTIVE:
                case PhoneEvent.ON_NOTIFICATION_DOUBLE_TAP:
                case PhoneEvent.SET_NOTIFICATION_EXPANDED:
                case PhoneEvent.RESET_NOTIFICATION_EXPANDED:
                case PhoneEvent.ON_NOTIFICATION_START_DRAGGING_DOWN:
                case PhoneEvent.ON_NOTIFICATION_STOP_DRAGGING_DOWN:
                case PhoneEvent.ON_NOTIFICATION_DISMISSED:
                case PhoneEvent.ON_NOTIFICATION_START_DISMISSING:
                case PhoneEvent.ON_NOTIFICATION_STOP_DISMISSING:
                case PhoneEvent.ON_RIGHT_AFFORDANCE_SWIPING_STARTED:
                case PhoneEvent.ON_LEFT_AFFORDANCE_SWIPING_STARTED:
                case PhoneEvent.ON_AFFORDANCE_SWIPING_ABORTED:
                case PhoneEvent.ON_CAMERA_ON:
                case PhoneEvent.ON_LEFT_AFFORDANCE_ON:
                case PhoneEvent.ON_UNLOCK_HINT_STARTED:
                case PhoneEvent.ON_CAMERA_HINT_STARTED:
                case PhoneEvent.ON_LEFT_AFFORDANCE_HINT_STARTED:
                  type_ = value;
                  bitField0_ |= 0x00000001;
                  break;
              }
    ...
    public Session clear() {
      ...
      build_ = "";
      result_ = Session.FAILURE;
      touchEvents = TouchEvent.emptyArray();
      sensorEvents = SensorEvent.emptyArray();
      touchAreaWidth_ = 0;
      touchAreaHeight_ = 0;
      type_ = Session.RESERVED_1;
      phoneEvents = PhoneEvent.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.sensorEvents != null && this.sensorEvents.length > 0) {
        for (int i = 0; i < this.sensorEvents.length; i++) {
          SensorEvent element = this.sensorEvents[i];
          if (element != null) {
      ...
      if (this.phoneEvents != null && this.phoneEvents.length > 0) {
        for (int i = 0; i < this.phoneEvents.length; i++) {
          PhoneEvent element = this.phoneEvents[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 50: {
            ...
            SensorEvent[] newArray =
                new SensorEvent[i + arrayLength];
            if (i != 0) {
              System.arraycopy(this.sensorEvents, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new SensorEvent();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 88: {
            int value = input.readInt32();
            switch (value) {
              case Session.RESERVED_1:
              case Session.RESERVED_2:
              case Session.RANDOM_WAKEUP:
              case Session.REAL:
              case Session.REJECTED_TOUCH_REPORT:
                type_ = value;
                bitField0_ |= 0x00000040;
                break;
            }
          ...
          case 98: {
            ...
            PhoneEvent[] newArray =
                new PhoneEvent[i + arrayLength];
            if (i != 0) {
              System.arraycopy(this.phoneEvents, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new PhoneEvent();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.

...
this.splitPrimaryTask(_arg0, _arg1, _arg2, _arg3);
return true;
}
...
@Override public void splitPrimaryTask(int topTaskId, int dragMode, int stackCreateMode, android.graphics.Rect initialBounds) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_splitPrimaryTask, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
public void splitPrimaryTask(int topTaskId, int dragMode, int stackCreateMode, android.graphics.Rect initialBounds) throws android.os.RemoteException;

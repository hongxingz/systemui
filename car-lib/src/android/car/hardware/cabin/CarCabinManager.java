...
public final class CarCabinManager implements CarManagerBase {
    ...
    private final static String TAG = "CarBodyControlManager";
    ...
    /**
     * Get an instance of CarBodyControlManager
     *
    ...
    /**
     * All properties in CarBodyControlManager are zoned.
     * @param propertyId
    ...
    /**
     * Get list of properties represented by CarBodyControlManager for this car.

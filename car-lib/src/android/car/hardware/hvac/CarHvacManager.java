...
public final class CarHvacManager implements CarManagerBase {
    ...
    /**
     * CCM driver mode set
     * 1 "Eco mode" 2 "Nomal mode"
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ_WRITE
     * @AreadId VehicleArea:GLOBAL
     */
    public static final int ID_CCM_DRIVER_MODE_SET = 0x21401626;
    /**
     * CCM driver mode respond
     * 1 "Eco mode" 2 "Nomal mode"
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ
     * @AreadId VehicleArea:GLOBAL
     */
    public static final int ID_CCM_DRIVER_MODE_RESP = 0x21401627;
    /**
     ...
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_RECIRC_ON = 0x21401627;
    /**
     ...
     */
    public static final int ID_HVAC_DEFROSTER = 0x13200504;
    /**
     ...
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_FAN_DIRECTION = 0x13200504;
    /**
     ...
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_AUTO_ON = 0x1520050a;
    /**
     ...
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_AC_ON = 0x1520050a;
    /**
     * Fan speed setting
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ_WRITE
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_FAN_SPEED = 0x15400500;
    /**
     * HVAC current temperature
     * areaId:  49 "left front current temperature" 68 "right front temperature."
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_TEMPERATURE_CURRENT = 0x15600502;
    /**
     ...
     */
    // public static final int ID_ENV_OUTSIDE_TEMPERATURE = 0x11600703;
    /**
     *User seat module pop up window
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ
     * @AreaId VehicleArea:GLOBAL
     */
    public static final int ID_USER_SAVING_POP_UP = 0x21401624;
    /**
     ...
     * @AreadId VehicleArea:SEAT
     */
    public static final int ID_HVAC_TEMPERATURE_SET = 0x15600503;
    /**
     * Seat heating/cooling
     * @change_mode VehiclePropertyChangeMode:ON_CHANGE
     * @access VehiclePropertyAccess:READ_WRITE
     * @AreaId VehicleArea:SEAT
     */
    public static final int ID_HVAC_SEAT_TEMPERATURE = 0x1540050b;
    ...
    @IntDef({
            ...
            ID_CCM_DRIVER_MODE_SET,
            ID_CCM_DRIVER_MODE_RESP,
            ID_HVAC_RECIRC_ON,
            ID_HVAC_DEFROSTER,
            ID_HVAC_FAN_DIRECTION,
            ID_HVAC_AUTO_ON,
            ID_HVAC_AC_ON,
            ID_HVAC_FAN_SPEED,
            ID_HVAC_TEMPERATURE_CURRENT,
            ID_ZONED_DUAL_ZONE_ON,
            // ID_ENV_OUTSIDE_TEMPERATURE,
            ID_USER_SAVING_POP_UP,
            ID_HVAC_TEMPERATURE_SET,
            ID_HVAC_SEAT_TEMPERATURE
    })
    ...
    /*******************************************aiways add **************************/
    /**
     * Represents fan direction when air flows through face adn floor directed vents.
     * This constant must be used with {@link #ID_ZONED_FAN_DIRECTION} property.
     */
    public static final int FAN_DIRECTION_FACE_FLOOR = 0x5;
    /**
     * Represents fan direction when air flows through floor and defrost directed vents.
     * This constant must be used with {@link #ID_ZONED_FAN_DIRECTION} property.
     */
    public static final int FAN_DIRECTION_FLOOR_DEFROST = 0x3;
    /**
     * Represents fan direction when air flows no request.
     * This constant must be used with {@link #ID_ZONED_FAN_DIRECTION} property.
     */
    public static final int FAN_DIRECTION_NO_REQUEST = 0x7;
    /********************************************************************************/

...
import wayos.car.settings.CustomKeySettingManager;
import wayos.car.settings.WayosCarConfigurationManager;
import wayos.car.hardware.energy.CarBatteryManager;
import wayos.car.hardware.drivermonitor.CarDMSManager;
import wayos.car.hardware.pas.CarPASManager;
import wayos.car.hardware.avm.CarAVMManager;
import wayos.car.hardware.cabin.CarLightManager;
import wayos.car.hardware.cabin.CarComfortManager;
import wayos.car.hardware.cabin.CarCabinExtendManager;
import wayos.car.hardware.sensor.CarAdasManager;
import wayos.car.media.CarAudioControlStrategyManager;
import wayos.car.updateEngine.CarOtherEcuUpdate;
...
public final class Car {
    ...
    @SystemApi
    public static final String CAR_WAYOS_CONFIGURATION_SERVICE = "wayosconfiguration";

    @SystemApi
    public static final String CAR_WAYOS_KEY_SETTINGS_SERVICE = "wayos_key_settings";
    ...
    /**
     * Service name for wayos 
     */
    @SystemApi
    public static final String CAR_PAS_SERVICE = "pas";
      /**
     * Service name for wayos 
     */
    @SystemApi
    public static final String CAR_DMS_SERVICE = "driver_monitor";

    @SystemApi
    public static final String CAR_AVM_SERVICE = "avm";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_LIGHT = "light";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_COMFORT = "comfort";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_CABIN_EXTEND = "cabin_extend";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_ADAS = "adas";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_BATTERY = "battery";
    
    @SystemApi
    public static final String CAR_VENDOR_SERVICE_AUDIO_CONTROL_STRATEGY = "audio_control_stragegy";

    @SystemApi
    public static final String CAR_VENDOR_SERVICE_ECU_UPDATE = "ecu_update";
    /**
    ...
    private CarManagerBase createCarManager(String serviceName, IBinder binder)
        ...
        switch (serviceName) {
            ...
            case CAR_MEDIA_SERVICE:
                ...
                break;
            case CAR_VENDOR_SERVICE_BATTERY:
                manager = new CarBatteryManager(binder, mContext, mEventHandler);
                break;
            case CAR_PAS_SERVICE:
                manager = new CarPASManager(binder, mContext, mEventHandler);
                break;
            case CAR_DMS_SERVICE:
                manager = new CarDMSManager(binder, mContext, mEventHandler);
                break;
            case CAR_WAYOS_CONFIGURATION_SERVICE:
                manager = new WayosCarConfigurationManager(binder);
                break;
            case CAR_WAYOS_KEY_SETTINGS_SERVICE:
                manager = new CustomKeySettingManager(binder, mContext);
                break;
            case CAR_AVM_SERVICE:
                manager = new CarAVMManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_LIGHT:
                manager = new CarLightManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_COMFORT:
                manager = new CarComfortManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_CABIN_EXTEND:
                manager = new CarCabinExtendManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_ADAS:
                manager = new CarAdasManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_AUDIO_CONTROL_STRATEGY:
                manager = new CarAudioControlStrategyManager(binder, mContext, mEventHandler);
                break;
            case CAR_VENDOR_SERVICE_ECU_UPDATE:
                manager = new CarOtherEcuUpdate(binder, mContext, mEventHandler);
                break;
            default:
                break;
        }

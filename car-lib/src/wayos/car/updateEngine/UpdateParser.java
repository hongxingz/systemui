...
public class UpdateParser {
    ...
    private static final String CARE_MAP = "care_map.txt";
    private static final String FILE_URL_PREFIX = "file://";
    private static final int ZIP_FILE_HEADER = 30;
    private String mCareMapText = "";
     ...
     */
    @Nullable
    public ParsedUpdate parse(@NonNull File file) throws IOException {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!payloadFound) {
                    ...
                    if (entry.getExtra() != null) {
                        ...
                        Log.d(TAG, " extra.length = " + entry.getExtra().length);
                    }
                }
                ...
                } else if(entry.getName().equals(CARE_MAP)) {
                    try (BufferedReader buffer = new BufferedReader(
                            new InputStreamReader(zipFile.getInputStream(entry)))) {
                        do{
                            mCareMapText += buffer.readLine() + "\n";
                        }while(buffer.ready());
                    }
                    Log.d(TAG, " mCareMapText = " + mCareMapText);
    ...
    public static class ParsedUpdate {
        ...
        public ParsedUpdate(String uri, long offset, long size, String[] props) {
            mUrl = uri;
            mOffset = offset;
            mSize = size;
            mProps = props;

...
public class CarrierText extends TextView {
    ...
    public CarrierText(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs, com.android.systemui.R.styleable.CarrierText, 0, 0);
        try {
            useAllCaps = a.getBoolean(com.android.systemui.R.styleable.CarrierText_allCaps, false);
            mShowAirplaneMode = a.getBoolean(com.android.systemui.R.styleable.CarrierText_showAirplaneMode, false);
            mShowMissingSim = a.getBoolean(com.android.systemui.R.styleable.CarrierText_showMissingSim, false);
        } finally {
            a.recycle();
        }
